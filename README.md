# Thermal-Camera-MLX90640-D110 from seengreat:www.seengreat.com
## I2C Communication：
...
sudo nano /boot/config.txt (for bullseye system)
or 
sudo nano /boot/firmware/config.txt (for bookworm system)
